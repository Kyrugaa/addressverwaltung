                        ...
                        if ($searchResults) {
                            foreach ($searchResults as $returnedPerson) { ?>
                                <li class="list-group-item">
                                    <h5>ID: <?php echo $returnedPerson['id'] ?></h5>
                                    ...
                                    <?php } ?>
                                    <?php if (isset($returnedPerson['addresses']) && is_array($returnedPerson['addresses'])) {
                                        foreach ($returnedPerson['addresses'] as $address) { ?>
                                            <hr>
                                    ...
                                    <a href="edit.php?id=<?php echo $returnedPerson['id']; ?>" class="btn btn-primary">Bearbeiten</a>
                            ...
                            foreach ($persons as $person) { ?>
                                <li class="list-group-item">
                                    ...
                                    <?php } ?>
                                    <?php if (isset($person['addresses']) && is_array($person['addresses'])) {
                                    ...
                                    <a href="edit.php?id=<?php echo $person['id']; ?>" class="btn btn-primary">Bearbeiten</a>
